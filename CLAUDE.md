...
The shared vocabulary of the Toopo catalogues: the address grammar and the domain list. The
catalogues and the client are checked against it; it depends on none of them.
